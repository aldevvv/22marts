        ...
        <div className="w-full max-w-md">
          ...
          <div className="rounded-2xl border border-zinc-200 bg-white p-8 shadow-sm">
            ...
            <div className="text-center">
              ...
              <h1 className="mt-6 text-xl font-semibold">Masuk ke Akun Anda</h1>
            ...
            <form onSubmit={handleSubmit} className="mt-6 space-y-4">
              ...
              <div className="flex items-center justify-between text-sm">
                ...
                <Link href="/lupa-password" className="font-medium text-zinc-900 hover:underline">
                  Lupa Kata Sandi?
                </Link>
              </div>
          ...
          <p className="mt-6 text-center text-sm text-zinc-500">
            Belum punya akun?{" "}
            <Link href="/daftar" className="font-medium text-zinc-900 hover:underline">
              Daftar Sekarang
            </Link>
          </p>
        </div>
